...
public class BoardController {
    ...
    /**
     * create.jsp에서 폼 제출 시 post 요청 -> 게시글 등록 작업을 수행하는 핸들러
     *
    ...
    public String create(BoardDTO board, RedirectAttributes ra) {
        ...
        // (1회성) 데이터를 세션에 잠깐 저장했다가 리다이렉트된 다음 요청에서 한 번만 꺼내 쓰고 사라짐
     ...
     * @param no : 조회할 게시글 번호
     * @param model : 조회할 게시글 (BoardDTO)
     */
    @GetMapping({"/get", "/update"}) // /get -> get.jsp, /update -> update.jsp
...
//    }
    ...
    /**
     * update.jsp에서 수정 시 post 요청 -> 게시글 수정 작업을 수행하는 핸들러 메서드
