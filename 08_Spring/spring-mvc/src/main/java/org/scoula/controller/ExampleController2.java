...
public class ExampleController2 {
    ...
    public String get(@ModelAttribute LoginRequestDTO dto, Model model) { // @ModelAttribute 생략 가능
    ...
    public String get(@PathVariable int id, Model model) { // @PathVariable("id") int id
